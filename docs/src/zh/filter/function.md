...
| `GROUP` | string | `"LIST"` | 命令所属的组，符合 [Command key specifications](https://redis.io/docs/reference/key-specs/)，可在 [commands](https://github.com/Arlowen/RedisShake/tree/main/backend/scripts/commands) 中查看 |
